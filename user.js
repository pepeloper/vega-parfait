...
/* background */
user_pref("parfait.bg.accent-color", true);
user_pref("parfait.bg.contrast", 2);
user_pref("parfait.bg.gradient", false);
user_pref("parfait.bg.opacity", 3);
...
user_pref("parfait.urlbar.results.compact", true);
user_pref("parfait.urlbar.search-mode.glow", true);

/* new tab */
user_pref("parfait.new-tab.logo", 2);
user_pref("parfait.new-tab.bg.pattern", false);

/* recommended Firefox tweaks */
